...
<body class="childrenBody">
	<form class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="realname" id="realname" type="text"
						value="${user.user_realname }" placeholder="请输入真实姓名"
			...
			<div class="layui-form-item" pane="">
				...
				<div class="layui-input-block">
					<input name="gender" id="gender" type="radio" name="sex" value="男"
						title="男" <c:if test="${user.user_sex eq '男' }">checked</c:if>>
					<input name="gender" id="gender" type="radio" name="sex" value="女"
						title="女" <c:if test="${user.user_sex eq '女' }">checked</c:if>>
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="email" id="email" type="text"
						value="${user.user_email }" placeholder="请输入邮箱"
		...
		<div class="user_right">
			<input type="file" name="dddd" class="layui-upload-file"
