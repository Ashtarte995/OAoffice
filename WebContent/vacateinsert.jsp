			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="start" id="start" type="text" value=""
						placeholder="请输入请假时间" lay-verify="required|date"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="time" id="time" type="text" value=""
						placeholder="请输入请假时长" lay-verify="required" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input name="user_id" id="user_id" type="text" value="${loginUser_id }"
						disabled placeholder="请输入您的id" lay-verify="required" class="layui-input">
				</div>
			</div> 
		</div>
